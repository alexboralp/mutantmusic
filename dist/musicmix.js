...
class MusicMix {
     ...
     */
    addSongChannels(leftChannel, rightChannel) {
     ...
     */
    loops(leftChannel, rightChannel, time) {
     ...
     * @param time El tiempo en segundos que se quiere que se repita el sonido.
     */
    leftToRightToBoth(leftChannel, rightChannel, time) {
        const numSamples = leftChannel.length;
        let mixLeftChannel = new Float32Array(0);
        let mixRightChannel = new Float32Array(0);
     ...
     * @param time El tiempo en segundos que se quiere que se repita el sonido.
     */
    sonidoSilencio(leftChannel, rightChannel, time) {
        const numSamples = leftChannel.length;
        // Copia el canal izquierdo y derecho para iniciar el loop
        let mixLeftChannel = new Float32Array(0);
        let mixRightChannel = new Float32Array(0);
...
//# sourceMappingURL=musicmix.js.map